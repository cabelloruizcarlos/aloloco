...
class LoginPagePresenter(private val view: LoginPageContract.LoginPageView,private val arguments: Bundle?, activity: BaseActivity):LoginPageContract.LoginPagePresenter {
